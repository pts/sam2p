      ...
      switch (opt) {
       ...
       case OPT_Margins:
        /* Dat:abbreviation letters are distinct: [ahxvylrtubd] */
             if (0!=(p2=one_pabbr(param,"all:"))) { all4: one_setdimen2(TopMargin, BottomMargin, p2); one_setdimen2(LeftMargin, RightMargin, p2); }
        else if (0!=(p2=one_pabbr(param,"horiz:"))
              || 0!=(p2=one_pabbr(param,"x:"))) one_setdimen2(LeftMargin, RightMargin, p2);
        else if (0!=(p2=one_pabbr(param,"vert:"))
              || 0!=(p2=one_pabbr(param,"y:"))) one_setdimen2(TopMargin, BottomMargin, p2);
        else if (0!=(p2=one_pabbr(param,"left:"))) one_setdimen2(LeftMargin, LeftMargin, p2);
        else if (0!=(p2=one_pabbr(param,"right:"))) one_setdimen2(RightMargin, RightMargin, p2);
        else if (0!=(p2=one_pabbr(param,"top:"))
              || 0!=(p2=one_pabbr(param,"up:"))) one_setdimen2(TopMargin, TopMargin, p2);
        else if (0!=(p2=one_pabbr(param,"bottom:"))
              || 0!=(p2=one_pabbr(param,"down:"))) one_setdimen2(BottomMargin, BottomMargin, p2);
        else { p2=param; goto all4; }
        break;
       case OPT_Scale:
