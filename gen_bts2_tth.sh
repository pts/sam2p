...
# perl -pe0 is a fancy way of doing `cat'.
...
perl -e 'die "mv $ARGV[0] to $ARGV[1]: $!\n" if !rename($ARGV[0], $ARGV[1])' -- l1g8z.pst.tmp.pst l1g8z.pst
...
perl -e 'die "mv $ARGV[0] to $ARGV[1]: $!\n" if !rename($ARGV[0], $ARGV[1])' -- l1ghz.pst.tmp.pst l1ghz.pst
...
perl -e 'die "mv $ARGV[0] to $ARGV[1]: $!\n" if !rename($ARGV[0], $ARGV[1])' -- l1gbz.pst.tmp.pst l1gbz.pst
...
perl -e 'die "mv $ARGV[0] to $ARGV[1]: $!\n" if !rename($ARGV[0], $ARGV[1])' -- l1g8l.pst.tmp.pst l1g8l.pst
...
perl -e 'die "mv $ARGV[0] to $ARGV[1]: $!\n" if !rename($ARGV[0], $ARGV[1])' -- l1ghl.pst.tmp.pst l1ghl.pst
...
perl -e 'die "mv $ARGV[0] to $ARGV[1]: $!\n" if !rename($ARGV[0], $ARGV[1])' -- l1gbl.pst.tmp.pst l1gbl.pst
...
perl -e 'for (@ARGV) { unlink $_ }' -- *.pst.tmp.* bts1.ttt bts2.ttt *.pst ps_tiny.gen
