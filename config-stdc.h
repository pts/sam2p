/* config-stdc.h. config.h replacement for standard C (works with gcc on Linux)  */
 ...
 */
#define PTS_INT16_T int16_t
#define PTS_UINT16_T uint16_t

/* A type name of a signed integral type of exactly 32 bits. Always defined.
 */
#define PTS_INT32_T int32_t
#define PTS_UINT32_T uint32_t

/* A type name of a signed integral type of exactly 64 bits. Maybe left
 * 0-defined.
 */
#define PTS_INT64_T int64_t
#define PTS_UINT64_T uint64_t
...
#define SIZEOF_BOOL SIZEOF_BOOL  /* Not used. */

/* !! The number of bytes in a char.  */
#define SIZEOF_CHAR SIZEOF_CHAR  /* Not used. */

/* ! The number of bytes in a very long.  */
#define SIZEOF_VERY_LONG 0

/* Example sizeofs.h, printed by print_sizeofs.c:
